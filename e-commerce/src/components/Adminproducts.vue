<template>
    <div class="container mx-auto p-6">
      ...
      <div class="bg-white p-4 rounded shadow mb-6">
        ...
        <input v-model="newProduct.price" type="number" class="w-full p-2 mb-2 border" placeholder="Price" />
        <textarea v-model="newProduct.description" class="w-full p-2 mb-2 border" placeholder="Description"></textarea>
        ...
        <input v-model="newProduct.stock" type="number" class="w-full p-2 mb-2 border" placeholder="Stock" />
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div v-for="product in productStore.products" :key="product.id" class="border p-4 rounded shadow">
          ...
          <div class="mt-2">
            <button @click="editProduct(product)" class="bg-yellow-500 text-white px-3 py-1 rounded mr-2">Edit</button>
  ...
  // Reset form
  const resetForm = () => {
    newProduct.value = { id: "", name: "", price: 0, description: "", imageUrl: "", category: "", stock: 0 };
